...
var Carousel = ({ images }) => {
  ...
  const [containerWidth, setContainerWidth] = (0, import_react22.useState)(0);
  const [contentWidth, setContentWidth] = (0, import_react22.useState)(0);
  const x = useMotionValue(0);
  ...
  (0, import_react22.useEffect)(() => {
    ...
    const updateDimensions = () => {
      if (containerRef.current) {
        ...
        const imageMargin = 8;
        const totalWidth = images.length * (imageWidth + imageMargin) + 20;
  ...
  return /* @__PURE__ */ import_react22.default.createElement("div", { className: "carousel-wrapper mb-24" }, /* @__PURE__ */ import_react22.default.createElement(
    motion.div,
    {
      ref: containerRef,
    ...
    /* @__PURE__ */ import_react22.default.createElement(
      ...
      images.map((src, index) => /* @__PURE__ */ import_react22.default.createElement(
        motion.img,
        {
          key: index,
          src,
